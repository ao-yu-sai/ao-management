package com.ai_offshore.tools.wbs.web.wbs.master.category.mapper;
...
public interface CategoryMapper {
    ...
    Category findByTypeCodeAndCode(String categoryTypeCode,
            String categoryCode);
    ...
    @Update("UPDATE category SET " + "category_code = #{newCategoryCode}, "
